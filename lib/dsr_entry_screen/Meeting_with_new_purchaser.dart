        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged: (String? selectedValue) {
                          ...
                          } else if (selectedValue == 'Phone Call with Builder/Stockist') {
                            _navigateTo(const PhoneCallWithBuilder());
                          } else if (selectedValue == 'Meetings With Contractor / Stockist') {
                            _navigateTo(const MeetingsWithContractor());
                          } else if (selectedValue == 'Visit to Get / Check Sampling at Site') {
                            _navigateTo(const CheckSamplingAtSite());
                          } else if (selectedValue == 'Meeting with New Purchaser(Trade Purchaser)/Retailer') {
                            // This is the current page, no navigation needed
                          } else if (selectedValue == 'BTL Activities') {
                            _navigateTo(const BtlActivites());
                          } else if (selectedValue == 'Internal Team Meetings / Review Meetings') {
                            _navigateTo(const InternalTeamMeeting());
                          } else if (selectedValue == 'Office Work') {
                            _navigateTo(const OfficeWork());
                          } else if (selectedValue == 'On Leave / Holiday / Off Day') {
                          ...
                          } else if (selectedValue == 'Phone call with Unregistered Purchasers') {
              ...
              Column(
                children:
                    _uploadRows.map((rowIndex) {
                      return Padding(
                        padding: const EdgeInsets.symmetric(vertical: 8.0),
                        child: Row(
                          mainAxisAlignment:
                              MainAxisAlignment
                                  .spaceBetween, // Distribute buttons
                          children: [
                            Expanded(
                              ...
                              child: ElevatedButton.icon(
                                onPressed:
                                    () => _pickImage(
                                      rowIndex,
                                    ), // Call _pickImage with the index
                                icon: const Icon(
                                  Icons.upload_file,
                                  size: 18,
                                ), // Added icon
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  backgroundColor:
                                      Colors.blueAccent, // Match AppBar color
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  ...
                                  if (_selectedImages[rowIndex] != null) {
                                    _showImageDialog(
                                      _selectedImages[rowIndex]!,
                                    ); // Show image for the current row
                                  } else {
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  foregroundColor: Colors.white,
                                  backgroundColor:
                                      Colors.orangeAccent, // Orange for add
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                  padding:
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  foregroundColor: Colors.white,
                                  backgroundColor:
                                      Colors.redAccent, // Red for remove
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                  padding:
